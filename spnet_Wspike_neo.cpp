...
const	int		NUM_EI_PATTERN = 11;	//				//EIの組み合わせの数
...
int	EI_1,EI_2;
int	num;
int               Ne[Ngr][NUM_EI_PATTERN]={{870,860,850,840,830,820,810,800,700,600,500},     {870,860,850,840,830,820,810,800,700,600,500}};
...
///     LAPの出力        //////
///////////////////////////////
      sprintf(fname_LAP_1,"LAP_1_EI_%d_%d_%dsec.txt",EI_1,EI_2,SIM_TIME);
      sprintf(fname_LAP_2,"LAP_2_EI_%d_%d_%dsec.txt",EI_1,EI_2,SIM_TIME);
...
/////////////////////////////////////////////////////////////////////////////////////////
		...
		{
			sprintf(fname_interpost_s_1,"interpost_s_%d_%dsec_%d_%d.txt",1,sec,EI_1,EI_2);
			sprintf(fname_interpost_s_2,"interpost_s_%d_%dsec_%d_%d.txt",2,sec,EI_1,EI_2);
			sprintf(fname_s_1,"s_%d_%dsec_%d_%d.txt",1,sec,EI_1,EI_2);
			sprintf(fname_s_2,"s_%d_%dsec_%d_%d.txt",2,sec,EI_1,EI_2);
